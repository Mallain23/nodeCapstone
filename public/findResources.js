...
const storeSearchResults = data => {
    ...
    if (data.length < 1) {
        ...
        $('.alert-message').text('Sorry, your search terms were too narrow and have not returned any results. Try refining your search terms!');
        $('.alert-message').show().delay(4000).fadeOut('slow');
